...
function checkemail() {
    try {
        ...
        if ($records > 0) {
            // Email already exists, redirect with an error code
            header("location:../register.php?p=$role&r=0927&e=exists");
        } else {
        ...
        // Database error, redirect with an error code
        header("location:../register.php?p=$role&r=4568&e=db_error");
    }
}
